...
\begin{tikzpicture}[syntaxdiagram]
  \graph{
    ...
    p1 --[vh way=0.5mm]
    {
      ...
      var p1,
      %
      value literal p0 -> value literal literal0/value literal[nonterminal] --
      value literal p1,
      %
      ...
      list p1 --[vh way=0.5mm]
      {
        ...
        list normal p1 -> list normal comma1/","[terminal] --
        list normal p2,
        %
...
\begin{tikzpicture}[syntaxdiagram]
  \graph{
    ...
    p1 --[vh way=0.5mm]
    {
      ...
      type var p1,
      %
      type literal p0 -> type literal type literal 0/type literal[nonterminal] --
      type literal p1,
      %
